...
unittest-dev-222:
	...
	@python -m pytest --fluent-version=22.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-dev-231:
	...
	@python -m pytest --fluent-version=23.1 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-dev-232:
	...
	@python -m pytest --fluent-version=23.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-dev-241:
	...
	@python -m pytest --fluent-version=24.1 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-dev-242:
	...
	@python -m pytest --fluent-version=24.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-222:
	...
	@python -m pytest --nightly --fluent-version=22.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-222-no-codegen:
	...
	@python -m pytest --nightly --fluent-version=22.2 -m "not codegen_required" $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-231:
	...
	@python -m pytest --nightly --fluent-version=23.1 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-231-no-codegen:
	...
	@python -m pytest --nightly --fluent-version=23.1 -m "not codegen_required" $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-232:
	...
	@python -m pytest --nightly --fluent-version=23.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-232-no-codegen:
	...
	@python -m pytest --nightly --fluent-version=23.2 -m "not codegen_required" $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-241:
	...
	@python -m pytest --nightly --fluent-version=24.1 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-241-no-codegen:
	...
	@python -m pytest --nightly --fluent-version=24.1 -m "not codegen_required" $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-242:
	...
	@python -m pytest --nightly --fluent-version=24.2 $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-solvermode-242:
	...
	@python -m pytest --fluent-version=24.2 --solvermode $(PYTESTRERUN) $(PYTESTEXTRA)
...
unittest-all-242-no-codegen:
	...
	@python -m pytest --nightly --fluent-version=24.2 -m "not codegen_required" $(PYTESTRERUN) $(PYTESTEXTRA)
