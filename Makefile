...
unittest-dev-232:
	@echo "Running unittests"
	@pip install -r requirements/requirements_tests.txt
	@python -m pytest -v -m "dev and fluent_232 and not fluent_222 and not fluent_231" --cov=ansys.fluent --cov-report html:cov_html --cov-config=.coveragerc
...
unittest-all-232:
	...
	@echo "Running all unittests"
	@pip install -r requirements/requirements_tests.txt
	@python -m pytest -v -m "fluent_232 and not fluent_222 and not fluent_231" --cov=ansys.fluent --cov-report html:cov_html --cov-config=.coveragerc --durations=0
