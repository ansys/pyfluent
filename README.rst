...
see `How does PyFluent infer the location to launch Fluent? <https://fluent.docs.pyansys.com/dev/getting_started/faqs.html#how-does-pyfluent-infer-the-location-to-launch-fluent>`_ in `Frequently asked questions <https://fluent.docs.pyansys.com/dev/getting_started/faqs.html>`_.
