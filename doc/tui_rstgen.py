...
if __name__ == "__main__":
    try:
        meshing_tui = importlib.import_module(
            f"ansys.fluent.core.generated.v{_get_file_or_folder(mode='meshing', is_datamodel=False).split('_')[-1]}.meshing.tui"
        )
    ...
    try:
        solver_tui = importlib.import_module(
            f"ansys.fluent.core.generated.v{_get_file_or_folder(mode='solver', is_datamodel=False).split('_')[-1]}.solver.tui"
        )
