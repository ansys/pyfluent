...
Pre/post mode
~~~~~~~~~~~~~
Run Ansys Fluent with only the setup and post-processing capabilities available. When Fluent is running in the pre-post mode it does not allow you to perform calculations.
