...
session is easier if you install a tool such as `pyreadline3
 <https://github.com/pyreadline3/pyreadline3>`_ which provides
...
Examples such as :ref:`_ref_exhaust_system_tui_api` in the PyFluent
documentation provide a guide for how to use this API.
