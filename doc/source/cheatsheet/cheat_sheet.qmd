...
EXAMPLE_DIR = "pyfluent/mixing_elbow"

def download_example_file(file_name):
    return examples.download_file(file_name, EXAMPLE_DIR)

mesh_file = download_example_file("mixing_elbow.msh.h5")
case_file = download_example_file("mixing_elbow.cas.h5")
data_file = download_example_file("mixing_elbow.dat.h5")
```
```{python}
# Read case
...
```{python}
file_name = download_example_file("mixing_elbow.pmdb")
watertight = meshing.watertight()
# Import Geometry
import_geom = watertight.import_geometry
import_geom.file_name = file_name
...
update_boundaries()
# Volume mesh
volume_mesh = watertight.create_volume_mesh
...
outlet_location = [solver.setup.boundary_conditions.pressure_outlet["outlet"]]
wall_location = [solver.setup.boundary_conditions.wall["wall-elbow"]]
# Area
