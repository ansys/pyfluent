...
from ansys.fluent.core.launcher.launcher import FLUENT_VERSION, set_ansys_version
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ansys-version",
        dest="ansys_version",
        help=f"Specify the ansys package version to use, default is {FLUENT_VERSION[0]}",
    )
    parser.add_argument(
        "--fluent-path",
        dest="fluent_path",
