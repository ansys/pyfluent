...
def test_solver_material(load_mixing_elbow_mesh):
    ...
    assert 'water-liquid' not in session.solver.root.setup.cell_zone_conditions.fluid[
    "elbow-fluid"].material()
    session.solver.root.setup.cell_zone_conditions.fluid[
    "elbow-fluid"].material = "water-liquid"
    assert 'water-liquid' in session.solver.root.setup.cell_zone_conditions.fluid[
    "elbow-fluid"].material()