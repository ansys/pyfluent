...
def test_create_graphics():
    pyvista_graphics1 = Graphics(None)
    pyvista_graphics2 = Graphics(None)
...
def test_contour():
    ...
    pyvista_graphics = Graphics(None)
    contour1 = pyvista_graphics.Contours["contour-1"]
    field_info = contour1.data_extractor.field_info()
    ...
    contour1.range_option.range_option = "auto-range-on"
    assert contour1.range_option.auto_range_off is None

    contour1.range_option.range_option = "auto-range-off"
    assert contour1.range_option.auto_range_on is None
    ...
    assert range[0] == pytest.approx(
        contour1.range_option.auto_range_off.minimum()
    )
    assert range[1] == pytest.approx(
        contour1.range_option.auto_range_off.maximum()
    )
...
def test_vector():
    ...
    field_info = vector1.data_extractor.field_info()
    ...
    vector1.range_option.range_option = "auto-range-on"
    assert vector1.range_option.auto_range_off is None

    vector1.range_option.range_option = "auto-range-off"
    assert vector1.range_option.auto_range_on is None
    ...
    assert range == pytest.approx(
        [
            vector1.range_option.auto_range_off.minimum(),
            vector1.range_option.auto_range_off.maximum(),
        ]
    )
...
def test_surface():
    ...
    field_info = surf1.data_extractor.field_info()
...
def test_create_plots():
    matplotlib_plots1 = Plots(None)
    matplotlib_plots2 = Plots(None)
...
def test_xyplots():
    ...
    matplotlib_plots = Plots(None)
    p1 = matplotlib_plots.XYPlots["p-1"]
    field_info = p1.data_extractor.field_info()
