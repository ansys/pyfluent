...
solver_session.solverworkflow.GlobalSettings.EnableTurboMeshing(True)
...
solver_session.solverworkflow.TWF_BladeRowAnalysisScope(ASSelectComponent="hannover")
...
solver_session.solverworkflow.TWF_ImportMesh(
    MeshFilePath=f"{inlet_guide_vane_file}", MeshName="IGV.gtm"
)
