...
def create_launcher(fluent_launch_mode: LaunchMode = None, **kwargs):
    ...
    if fluent_launch_mode == LaunchMode.STANDALONE:
        return StandaloneLauncher(
            ...
            ui_mode=kwargs.get("ui_mode", None),
            graphics_driver=kwargs.get("graphics_driver", None),
            product_version=kwargs.get("product_version", None),
            version=kwargs.get("version", None),
            precision=kwargs.get("precision", None),
            processor_count=kwargs.get("processor_count", None),
            journal_file_names=kwargs.get("journal_file_names", None),
            start_timeout=kwargs.get("start_timeout", None),
            additional_arguments=kwargs.get("additional_arguments", None),
            env=kwargs.get("env", None),
            cleanup_on_exit=kwargs.get("cleanup_on_exit", None),
            start_transcript=kwargs.get("start_transcript", None),
            case_file_name=kwargs.get("case_file_name", None),
            case_data_file_name=kwargs.get("case_data_file_name", None),
            lightweight_mode=kwargs.get("lightweight_mode", None),
            py=kwargs.get("py", None),
            gpu=kwargs.get("gpu", None),
            cwd=kwargs.get("cwd", None),
            topy=kwargs.get("topy", None),
            start_watchdog=kwargs.get("start_watchdog", None),
            file_transfer_service=kwargs.get("file_transfer_service", None),
        )
        ...
        return DockerLauncher(
            ...
            additional_arguments=kwargs.get("additional_arguments", None),
            env=kwargs.get("env", None),
            container_dict=kwargs.get("container_dict", None),
        ...
        return PIMLauncher(
            ...
            processor_count=kwargs.get("processor_count"),
            journal_file_names=kwargs.get("journal_file_names"),
            start_timeout=kwargs.get("start_timeout"),
            additional_arguments=kwargs.get("additional_arguments"),
            env=kwargs.get("env"),
            cleanup_on_exit=kwargs.get("cleanup_on_exit"),
            start_transcript=kwargs.get("start_transcript"),
            case_file_name=kwargs.get("case_file_name"),
            case_data_file_name=kwargs.get("case_data_file_name"),
            lightweight_mode=kwargs.get("lightweight_mode"),
            py=kwargs.get("py"),
            gpu=kwargs.get("gpu"),
            cwd=kwargs.get("cwd"),
            topy=kwargs.get("topy"),
