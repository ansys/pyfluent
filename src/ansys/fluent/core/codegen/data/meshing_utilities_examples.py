...
meshing_utility_examples = {
    ...
    "separate_cell_zone_layers_by_face_zone": [
        "meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_id_list=[87], face_zone_id_list=[30, 31, 32], nlayers=2)",
        'meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_id_list=[87], face_zone_name_list=["cold-inlet", "hot-inlet", "outlet"], nlayers=2)',
        'meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_id_list=[87], face_zone_name_pattern="cold*", nlayers=2)',
        'meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_name="elbow", face_zone_id_list=[30, 31, 32], nlayers=2)',
        'meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_name="elbow", face_zone_name_list=["cold-inlet", "hot-inlet", "outlet"], nlayers=2)',
        'meshing_session.meshing_utilities.separate_cell_zone_layers_by_face_zone(prism_cell_zone_name="elbow", face_zone_name_pattern="cold*", nlayers=2)',
    ],
