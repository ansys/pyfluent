...
_DATA = [
    ...
    ("Materials", "Singleton", "setup.models.materials"),
    ("Material", "NamedObject", "setup.models.materials"),
    ("CellZoneConditions", "Singleton", "setup.models.cell_zone_conditions"),
    ("CellZoneCondition", "NamedObject", "setup.models.cell_zone_conditions"),
    ("FluidCellZones", "Singleton", "setup.models.cell_zone_conditions.fluid"),
    ("FluidCellZone", "NamedObject", "setup.models.cell_zone_conditions.fluid"),
    ("SolidCellZones", "Singleton", "setup.models.cell_zone_conditions.solid"),
    ("SolidCellZone", "NamedObject", "setup.models.cell_zone_conditions.solid"),
