...
class Root(PyMenu):
    ...
    class GenerateTheMultiZoneMesh(PyCommand):
        """
        GenerateTheMultiZoneMesh(OrthogonalQualityLimit: float, RegionScope: List[str], NonConformal: str, SizeFunctionScaleFactor: float, CFDSurfaceMeshControls: Dict[str, Any], CompleteRegionScope: List[str]) -> bool
        """
        pass
