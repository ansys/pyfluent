...
from .first_to_second_order_blending_list import (
    first_to_second_order_blending_list,
)
...
class spatial(Group):
    ...
    child_names = [
        ...
        "first_to_second_order_blending_list",
        "scheme",
        "flow_skew_diffusion_exclude",
        "scalars_skew_diffusion_exclude",
        "rhie_chow_flux_specify",
        "rhie_chow_method",
    ]
