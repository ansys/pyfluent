...
class GraphicsWidget:
    ...
    def __init__(self, app, obj, update_vtk_fun):
        ...
        self._all_widgets[self.get_unique_name("display")]= self.get_button(self.get_unique_name("display")) 
        ...
        return dbc.Row(
         ...
         [
          dbc.Col(
            ...
            dbc.Col(dbc.Card(children = list(self._all_widgets.values()), body=True), md=2),#      
          ],
          style={"height": "50rem"},
        )        
        ...
        for name,value in obj.__dict__.items():       
            ...
            if value.__class__.__class__.__name__ in ("PyLocalPropertyMeta", "PyLocalObjectMeta"):               
                if value.__class__.__class__.__name__ == "PyLocalPropertyMeta":
                    widget =  self.get_widget(value, value._type, name, self.get_unique_name(name), getattr(value, "attributes", None) )                    
        ...
        for name,value in obj.__dict__.items():       
            ...
            if value.__class__.__class__.__name__ in ("PyLocalPropertyMeta", "PyLocalObjectMeta"):
                ...
                if value.__class__.__class__.__name__ == "PyLocalPropertyMeta":
                    ...
                    self._visible_widgets.append((self.get_unique_name(name), value()))
                else:
    ...
    def get_button(self, unique_name):
        widget = self._all_widgets.get(unique_name) 
        if widget is not None:            
            return widget    
                     
        button = html.Button(unique_name, id=unique_name,  n_clicks=0) 
