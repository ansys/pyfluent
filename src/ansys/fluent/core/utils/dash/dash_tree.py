...
@app.callback(
    Output("output-checked", "children"), [Input("input", "checked")]
)
...
@app.callback(
    Output("output-selected", "children"), [Input("input", "selected")]
)
...
@app.callback(
    Output("output-expanded", "children"), [Input("input", "expanded")]
)
