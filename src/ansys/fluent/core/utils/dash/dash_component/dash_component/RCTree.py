...
- setProps (optional):
    ...
    properties change."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, selected=Component.UNDEFINED, expandedKeys=Component.UNDEFINED, data=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'data', 'expandedKeys', 'selected', 'setProps']
        self._type = 'RCTree'
        self._namespace = 'dash_component'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'data', 'expandedKeys', 'selected', 'setProps']
