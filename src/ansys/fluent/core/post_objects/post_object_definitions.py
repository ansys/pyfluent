...
class SurfaceDefn(GraphicsDefn):
    ...
    class definition(metaclass=PyLocalObjectMeta):
        ...
        class plane_surface(metaclass=PyLocalObjectMeta):
            ...
            @Attribute
            def is_active(self):
                return self.parent.type() == "plane-surface"
            ...
            class xy_plane(metaclass=PyLocalObjectMeta):
                ...
                @Attribute
                def is_active(self):
                    return self.parent.creation_method() == "xy-plane"
            ...
            class yz_plane(metaclass=PyLocalObjectMeta):
                ...
                @Attribute
                def is_active(self):
                    return self.parent.creation_method() == "yz-plane"
            ...
            class zx_plane(metaclass=PyLocalObjectMeta):
                ...
                @Attribute
                def is_active(self):
                    return self.parent.creation_method() == "zx-plane"
        ...
        class iso_surface(metaclass=PyLocalObjectMeta):
            ...
            @Attribute
            def is_active(self):
                return self.parent.type() == "iso-surface"
...
class ContourDefn(GraphicsDefn):
    ...
    class range(metaclass=PyLocalObjectMeta):
        ...
        class auto_range_on(metaclass=PyLocalObjectMeta):
            ...
            @Attribute
            def is_active(self):
                return self.parent.option() == "auto-range-on"
        ...
        class auto_range_off(metaclass=PyLocalObjectMeta):
            ...
            @Attribute
            def is_active(self):
                return self.parent.option() == "auto-range-off"
