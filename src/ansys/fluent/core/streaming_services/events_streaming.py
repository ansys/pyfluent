...
class Event(Enum):
    ...
    ABOUT_TO_READ_CASE = "AboutToReadCaseEvent"
    CASE_READ = "CaseReadEvent"
    ABOUT_TO_READ_DATA = "AboutToReadDataEvent"
    DATA_READ = "DataReadEvent"
    ABOUT_TO_INITIALIZE = "AboutToInitializeEvent"
